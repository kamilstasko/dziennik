<%@ Page Title="EdytujPrzedmioty" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="EdytujPrzedmioty.aspx.cs" Inherits="MyWeb.EdytujPrzedmioty" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
        <table cellpadding="5" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td><asp:TextBox ID="m_change_przedmiot" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>
